...
QT_MOC_LITERAL(7, 91, 14), // "server_get_map"
QT_MOC_LITERAL(8, 106, 11), // "onConnected"
QT_MOC_LITERAL(9, 118, 14), // "onDisconnected"
QT_MOC_LITERAL(10, 133, 21), // "onTextMessageReceived"
QT_MOC_LITERAL(11, 155, 7), // "message"
QT_MOC_LITERAL(12, 163, 23), // "onBinaryMessageReceived"
QT_MOC_LITERAL(13, 187, 7) // "onTimer"

    },
    "ServerHandler\0server_pause\0\0server_resume\0"
    "server_new_target\0server_new_call\0"
    "server_set_ini\0server_get_map\0onConnected\0"
    "onDisconnected\0onTextMessageReceived\0"
    "message\0onBinaryMessageReceived\0onTimer"
};
...
void ServerHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->server_get_map(); break;
        ...
        {
            using _t = void (ServerHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerHandler::server_get_map)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void ServerHandler::server_get_map()
{
