...
QT_MOC_LITERAL(3, 25, 10), // "pullFailed"
QT_MOC_LITERAL(4, 36, 16), // "processLogOutput"
QT_MOC_LITERAL(5, 53, 17), // "processPullOutput"
QT_MOC_LITERAL(6, 71, 16), // "processPullError"
QT_MOC_LITERAL(7, 88, 18), // "processResetOutput"
QT_MOC_LITERAL(8, 107, 17) // "processResetError"

    },
    "HTTPHandler\0pullSuccess\0\0pullFailed\0"
    "processLogOutput\0processPullOutput\0"
    "processPullError\0processResetOutput\0"
    "processResetError"
};
...
void HTTPHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->pullFailed(); break;
        case 2: _t->processLogOutput(); break;
        case 3: _t->processPullOutput(); break;
        case 4: _t->processPullError(); break;
        case 5: _t->processResetOutput(); break;
        case 6: _t->processResetError(); break;
        default: ;
        }
        ...
        {
            using _t = void (HTTPHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HTTPHandler::pullFailed)) {
                *result = 1;
                return;
            }
        }
